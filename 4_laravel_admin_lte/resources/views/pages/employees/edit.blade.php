...
@section('content')
    ...
    <div class="card-body border col-6">
        ...
        {!! Form::open(['url' => route('employees.update', ['employee' => $model]), 'class'=>'form-horizontal', 'method'=>'PATCH', 'enctype'=>'multipart/form-data']) !!}
        ...
        @include('form_elements.select', [
            ...
            'selectedValue' => [$model->position->id => $model->position->name],
        ...
        @include('form_elements.select', [
            ...
            'selectedValue' => $model->head ? [$model->head->id => $model->head->name] : null,
