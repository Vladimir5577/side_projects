...
<a href="{{ route('positions.edit', ['position' => $row]) }}" class="text-secondary"><i class="fas fa-pencil-alt"></i></a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Are you sure you want to remove position {{ $row->name }}?
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-outline-secondary" data-dismiss="modal">Cancel</button>
                {!! Form::open(['url' => route('positions.destroy', ['position' => $row]), 'class'=>'form-horizontal', 'method'=>'POST']) !!}
                {{ method_field('DELETE') }}
